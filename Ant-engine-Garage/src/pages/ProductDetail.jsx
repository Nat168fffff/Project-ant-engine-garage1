...
const products = [
  {
    ...
    specs: ["วัสดุ: ไทเทเนียม", "เหมาะกับ s2000", "รับประกัน 2ปี"],
  },
  {
    id: 2,
    ...
    specs: ["วัสดุ: อะลูมิเนียม ", "เหมาะกับ FK8 R", "รับประกัน 2ปี"],
  },
  {
    id: 3,
    name: "Nitrous oxide",
    ...
    specs: ["วัสดุ: เหล็ก ", "เหมาะกับ รถที่เครื่องยนต์รับกำลังอัดทีสูงๆไหว", "รับประกัน 1ปี"],
  },
  {
    id: 4,
    ...
    specs: ["วัสดุ: อะลูมิเนียม", "เหมาะกับ GTR R31-34", "รับประกัน 2ปี"],
  },
  {
    id: 5,
    name: "FLEX Turbo F55",
    ...
    specs: ["วัสดุ: อะลูมิเนียม,เหล็ก", "เหมาะกับ รถยนต์กระบะ ", "รับประกัน 2ปี"],
  },
  {
    id: 6,
    ...
    specs: ["วัสดุ: อะลูมิเนียม,คาร์บอนไฟเบอร์ ", "เหมาะกับ HONDA CIVIC TYPE R FL5", "รับประกัน 2ปี"],
  },

  {
    ...
    specs: ["วัสดุ: อะลูมิเนียม,หนังแท้ ", "เหมาะกับ civic ", "รับประกัน 2ปี"],
  },

  {
    ...
    specs: ["วัสดุ: เหล็กกล้าไร้สนิมคุณภาพสูงชนิด 304 ", "เหมาะกับ FL5 ", "รับประกัน 2ปี"],
  },

  {
    ...
    specs: ["วัสดุ: เหล็กกล้าฟอร์จ, อะลูมิเนียม, เหล็กหล่อ", "เหมาะกับ Nissan Skyline GTR R34, Cefiro A31 ", "รับประกัน 1ปี "],
  },

  {
    ...
    specs: ["วัสดุ: ไฟเบอร์กลาส, คาร์บอนไฟเบอร์เสริมแรง, คาร์บอนแบบดราย", "เหมาะกับ Nissan GTR R35", "รับประกัน 1ปี "],
  },

  {
    ...
    specs: ["วัสดุ: คาร์บอนไฟเบอร์", "เหมาะกับ Civic FD1,2", "รับประกัน 1ปี"],
  },

  {
    ...
    specs: ["วัสดุ: ไฟเบอร์กลาส ", "เหมาะกับ Toyota Supra Mk4", "รับประกัน 6เดือน"],
  },

  {
    ...
    specs: ["วัสดุ: คาร์บอนไฟเบอร์", "เหมาะกับ Ferrari F40 ", "รับประกัน ไม่มี"],
  },

  {
    ...
    specs: ["วัสดุ: พลาสติกเสริมแรงแบบยืดหยุ่น", "เหมาะกับ Nissan Skyline GTR R34 ", "รับประกัน 2ปี"],
  },

  {
    ...
    specs: ["วัสดุ: คาร์บอนไฟเบอร์,พลาสติกเสริมแรง", "เหมาะกับ Nissan Skyline GTR R34", "รับประกัน 6เดือน"],
  },

  {
    ...
    specs: ["วัสดุ: พลาสติกเสริมแรง ", "เหมาะกับ Nissan Skyline GTR R34", "รับประกัน 6เดือน"],
  },
  {
    id: 17,
    ...
    specs: ["วัสดุ: ไฟเบอร์กลาส", "เหมาะกับ Nissan Silvia S15 ", "รับประกัน 1ปี "],
  },
  {
    id: 18,
    ...
    specs: ["วัสดุ: ไฟเบอร์กลาส ", "เหมาะกับ Mazda Rx7", "รับประกัน 1ปี"],
  },
  {
    id: 19,
    ...
    specs: ["วัสดุ: คาร์บอนไฟเบอร์", "เหมาะกับ Mclaren 720S", "รับประกัน 6เดือน"],
  },
  {
    id: 20,
  ...
  },
  {
    ...
    specs: ["วัสดุ: พลาสติก ", "เหมาะกับ Civic FD ", "รับประกัน 2ปี"],
  },
  {
    id: 22,
    ...
    specs: ["วัสดุ: เหล็ก", "เหมาะกับ กระบะ Dmax ", "รับประกัน 2เดือน"],
  },
  {
    id: 23,
    ...
    specs: ["วัสดุ: เหล็กกล้า,คาร์บอน,หนังแท้ ", "เหมาะกับ Civic ", "รับประกัน 1ปี"],
  },
  {
    id: 24,
    ...
    specs: ["วัสดุ: เหล็กกล้า,คาร์บอน,ผ้า", "เหมาะกับ รถทกรุ่น", "รับประกัน 1ปี"],
  },
  {
    id: 25,
    ...
    specs: ["วัสดุ: คาร์บอนไฟเบอร์,โพลียูรีเทน ", "เหมาะกับ Lamborghini Urus", "รับประกัน 6เดือน"],
  },
  {
    id: 26,
    ...
    specs: ["วัสดุ: คาร์บอนไฟเบอร์", "เหมาะกับ ร้านเกม ", "รับประกัน ไม่มี"],
  },
  {
    id: 27,
    ...
    specs: ["วัสดุ: อลูมิเนียม ", "เหมาะกับ รถทุกคัน", "รับประกัน 3ปี"],
  },
  {
    id: 28,
    name: "พาร์ท อีโว สำหรับ อีคาร์",
    price: "9,900 บาท",
    image:
    ...
    specs: ["วัสดุ: พลาสติก", "เหมาะกับ อีคาร์(GLXi,Lancer CB2-4", "รับประกัน 1ปี "],
  },
  {
    id: 29,
    ...
    specs: ["วัสดุ: คาร์บอนไฟเบอร์", "เหมาะกับ Civic FD", "รับประกัน 1ปี "],
  },
  {
    id: 30,
    ...
    specs: ["วัสดุ:คาร์บอนไฟเบอร์,อลูมิเนียม ", "เหมาะกับ Civic FD2", "รับประกัน 1ปี"],
  },
];
